    ...
    humanoidHack: {
      ...
      editions: [
        ...
        },
        {
          ...
          status: 'Upcoming',
          lead: 'The second edition scales up — more robots, more teams, and a growing developer community feeding into FleetSeek.',
          facts: [
            { label: 'Dates', value: 'July 11–12, 2026' },
            { label: 'Venue', value: 'GMO Humanoid Lab, Shibuya' },
            { label: 'Robots', value: 'Unitree G1 × 3' },
            { label: 'Teams', value: '6 teams' },
            { label: 'Entry', value: 'Free' },
            { label: 'Host', value: 'Orboh-Japan · RobotMateHub' },
          ],
          partners: 'In cooperation with GMO AIR · Unitree Robotics',
          highlights: [
            'Three Unitree G1 humanoids for six teams',
            'Open Discord community for participants',
            'Day 2 public demo showcase',
          ],
        },
      ],
